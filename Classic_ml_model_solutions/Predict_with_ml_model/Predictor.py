...
from Classic_ml_model_solutions.Dataset_pipeline.FeaturesEngineer.FeaturesEngineer import FeaturesEngineer
from Classic_ml_model_solutions.Models_builder_pipeline.ModelsTrainer.logistic_reg_model_train import add_price_vs_sma_target
...
class Predictor:
    ...
    def _load_model(self):
        """Load model from Classic_ml_model_solutions/Created_models_to_use/{config_name}/."""
        models_folder = os.path.join("Classic_ml_model_solutions", "Created_models_to_use", self.config_name)
    ...
    def save_predictions(
        ...
        Args:
            ...
            output_path: Custom output path (default: Classic_ml_model_solutions/Created_models_to_use/{config_name}/predictions.json)
        ...
        if output_path is None:
            output_path = os.path.join("Classic_ml_model_solutions", "Created_models_to_use", self.config_name, "predictions.json")
