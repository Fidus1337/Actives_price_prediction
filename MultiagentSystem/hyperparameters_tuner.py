...
if __name__ == "__main__":
    ...
    save_path = Path(__file__).parent / "tuning_top.json"
    ...
    find_best_hyperparameters(
        ...
        save_path=save_path,
        step=0.1,
        decay_rate_range=(0.05, 0.20, 0.05),
        decay_start_day_range=(1, 21, 7),
        initial_weight_range=(0.5, 1, 0.25),
        window_to_analysis_range=(7, 30, 7),
        eval_days=100,
        top_k=50,
    )
